<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-L9ET9WREFZ"></script>
<script>
...
<div class="feat-item feat-with-image">
  ...
  <div class="feat-text">
    ...
    <div class="feat-desc">
      In-progress senior design retrofit mechanism using controlled rotation and sacrificial
      breakaway to reduce wind-induced signpost damage.
    </div>

    <a class="read-more" href="road-sign-system.html">
      Read more →
    </a>
  </div>
  ...
  <a class="feat-image is-cad is-medium" href="road-sign-system.html">
    ...
    <img class="img-default"
         src="images/roadsign_card_assembled.png"
         alt="Reactive Road Sign System assembled CAD" />

    <img class="img-hover"
         src="images/roadsign_card_exploded.png"
         alt="Reactive Road Sign System exploded CAD" />
  ...
  <div class="feat-item feat-with-image">
    ...
    <a class="feat-image is-photo is-medium" href="adml.html">
      ...
      <img class="img-hover" src="images/fishkit_open.jpg"
           alt="Modular kit opened showing internal compartments" />
    </a>
  </div>
</div>
